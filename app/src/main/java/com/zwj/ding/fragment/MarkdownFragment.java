...
public class MarkdownFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_markdown, container, false);
    }
        ...
        switch (v.getId()) {
            case R.id.btn_send:
                ...
                if(!webhookString.isEmpty() && !titleString.isEmpty()
                        && !markdownString.isEmpty() ) {
                    btnSend.setEnabled(false);
                    RequestBody body = RequestBody.create(MyApplication.MEDIA_TYPE, toJsonString(titleString, markdownString));
    ...
    public String toJsonString(String title, String markdownText) {
