...
public class LinkMsgFragment extends Fragment implements View.OnClickListener{
    private EditText etWebhook;
    private EditText etTitle, etDes, etMsgLink;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_link, container, false);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_send:
                ...
                String desString = etDes.getText().toString().trim();
                String msgLinkString = etMsgLink.getText().toString().trim();
                if(!webhookString.isEmpty() && !titleString.isEmpty()
                        && !desString.isEmpty() && !msgLinkString.isEmpty()) {
                    btnSend.setEnabled(false);
                    RequestBody body = RequestBody.create(MyApplication.MEDIA_TYPE, toJsonString(titleString, desString, msgLinkString, null));
    ...
    public String toJsonString(String title, String text, String messageUrl, String picUrl) {
