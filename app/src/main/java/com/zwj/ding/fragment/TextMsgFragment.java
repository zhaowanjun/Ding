...
public class TextMsgFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_send:
                ...
                String textString = etText.getText().toString().trim();
                if(!webhookString.isEmpty() && !textString.isEmpty()) {
                    btnSend.setEnabled(false);
                    RequestBody body = RequestBody.create(MyApplication.MEDIA_TYPE, toJsonString(textString, null, false));
    ...
    public String toJsonString(String content, List<String> atMobiles, boolean isAtAll) {
